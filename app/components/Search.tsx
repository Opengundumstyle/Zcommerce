  ...
  const handleSubmit = (e: { preventDefault: () => void }) => {
    ...
    return(
        <div className="relative w-full" >
            ...
            <div className={`flex flex-row border-2 rounded-2xl p-2 hover:border-black hover:shadow-xl items-center transition-all duration-200 ${query?'border-teal-700':'border-transparent' }`}
